...
c1 = [BernsteinPoly(px(1,:), t); BernsteinPoly(py(1,:), t)];
c2 = [BernsteinPoly(px(2,:), t); BernsteinPoly(py(2,:), t)];
...
% Plot the velocities
figure(2)
plot(t, BernsteinPoly(V(1,:),t)); hold on
plot(t, BernsteinPoly(V(2,:),t));
grid on

% Plot the ang velocities
figure(3)
plot(t, BernsteinPoly(omega(1,:),t)); hold on
plot(t, BernsteinPoly(omega(2,:),t));
grid on
